...
#We'll work directly from the CSV so no need to upload to firestore
# def upload_csv_to_firestore():
#     try:
#         df = pd.read_csv("/Users/taracan/Documents/SWENG894/Admissions-Management-System/DummyDataXtraLite.csv")
#     except FileNotFoundError:
#         print(f"Error:CSV file not found at {csv_file_path}")
#         return
#     for index, row in df.iterrows():
#         doc_ref = db.collection("studentsXtraLite").document()
